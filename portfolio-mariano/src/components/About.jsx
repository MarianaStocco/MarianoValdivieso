  ...
  return (
    ...
    <div className='container mx-auto'>
      <div className='flex flex-col lg:flex-row gap-x-[70px] items-center'>
        ...
        >
          <div className='text-[220px] xl:text-[220px] leading-none font-primary font-extrabold lg:-tracking-[0.055em] bg-about bg-no-repeat bg-center bg-clip-text text-transparent'>
            01
          </div>
        </motion.div>
        {/* text */}
